...
//   $.ajax({
//     type:'GET',
//     url:'http://localhost:8080/EmployeeInfo?email='+email,
...
//   var pass=$("#passId").val();
//   if(pass==obj[0].passsword){
//     alert('authenticated');
//     name = localStorage[obj[0].name];
//    $(location).attr('href', 'http://localhost:8080/StudentPage.html')
//   }else{
//     alert('try again');
//   }
//   // alert(EmployeeInfo);
