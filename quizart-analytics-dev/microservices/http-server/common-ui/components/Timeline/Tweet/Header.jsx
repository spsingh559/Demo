  ...
  render () {
    ...
    return (
      <div className="header">
        <a className="account-group" style={styles.accountGroup} href={`http://twitter.com/${data.user.screen_name}`} target='_blank'>
        ...
        <small className="time" style={styles.time}>
          <a href={`http://twitter.com/${data.user.screen_name}/status/${data.id_str}`} className="tweet-timestamp" style={styles.timestamp} target='_blank'>
            {' • '}{timestamp}
          </a>
        </small>
      </div>
